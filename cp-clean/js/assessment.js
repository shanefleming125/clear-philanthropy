...
FUNDRAISING EFFICIENCY GUIDANCE: A low fundraising expense ratio (e.g., 7–15%) means the organization spent a small amount to raise each dollar of contributed revenue — this is generally reasonable. Do not say "generates X dollars per $100 spent" (that is backwards). Instead say something like "spent approximately X cents to raise each dollar of contributed revenue" or "fundraising costs represent X% of total contributions received." Do NOT describe a fundraising efficiency ratio as "high" or "concerning" purely based on the percentage — context matters. If the ratio appears reasonable but the organization still shows heavy revenue concentration or dependence on a small number of funders, the more accurate observation is: the fundraising model does not appear to be producing sufficient revenue diversification to reduce financial risk, not that fundraising is inefficient per se. Frame the issue as a strategic mismatch between fundraising activity and diversification outcomes, not as wasteful spending.
